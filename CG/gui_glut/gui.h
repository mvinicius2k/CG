...
class GUI {
    ...
    public:
        GUI( int width, int height, displayFunction dFunction = glutGUI::defaultDisplay, keyFunction kFunction = glutGUI::defaultKey, mouseButtonFunction mbFunction = glutGUI::defaultMouseButton, const char *title = "GLUT", int argc = 0, char** argv = nullptr);
        void GLUTInit();
        void GLInit();
        ~GUI();
